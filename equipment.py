    ...
    def __init__(self, group, player):
        ...
        if playerItemEquipped in equipmentItems:
            match playerDirection:
                ...
                case "Left":  self.rect = self.image.get_rect(midright=player.rect.midleft + pg.math.Vector2(12, 8))
                case "Right": self.rect = self.image.get_rect(midleft=player.rect.midright - pg.math.Vector2(12, -8))
